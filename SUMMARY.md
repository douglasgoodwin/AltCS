...
* [SEQUENCE: Draw with Lines](the-modules/untitled/README.md)
  * [Drawing with Algorithms](the-modules/untitled/drawing-with-algorithms/README.md)
    * [Encode a drawing](the-modules/untitled/drawing-with-algorithms/encode-a-drawing.md)
...
* [RECURSION: Natural Patterns](the-modules/recursion-natural-patterns/README.md)
  ...
  * [Magnetic Botany](the-modules/recursion-natural-patterns/magnetic-botany.md)
* [ITERATION: So Random](the-modules/iteration-so-random.md)
* [FUNCTIONS: Draw Curves](the-modules/functions-draw-curves/README.md)
...
* [ACADEMIC INTEGRITY](academic-policies/academic-integrity.md)
* [ACADEMIC ACCOMMODATIONS](academic-policies/academic-accommodations.md)
...
* [Exercise 8](exercises/exercise-8.md)
